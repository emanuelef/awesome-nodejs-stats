...
const csvURL =
  "https://raw.githubusercontent.com/emanuelef/awesome-nodejs-repo-stats/main/dep-repo-latest.csv";
...
const columns: GridColDef[] = [
  ...
  {
    field: "awesome_nodejs_repos_using_dep",
    headerName: "Repos #",
    width: 100,
    ...
    <div>
      <DataGrid
        ...
        initialState={{
          ...
          sorting: {
            sortModel: [
              { field: "awesome_nodejs_repos_using_dep", sort: "desc" },
            ],
          },
        }}
